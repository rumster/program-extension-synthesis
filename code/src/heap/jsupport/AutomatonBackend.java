...
public class AutomatonBackend {
	...
	private final HeapProblem problem;
	private final Configuration config;
	private final HeapDebugger debugger;

	public AutomatonBackend(Automaton automaton, HeapProblem problem, Configuration config, HeapDebugger debugger) {
