 ...
 * @author romanm
 */
public class OpOr extends InternalNode {
	protected List<Node> args = new ArrayList<>(2);

	protected OpOr(int numOfNonterminals) {
	 ...
	 */
	public OpOr(Node lhs, Node rhs) {
		super(lhs.numOfNonterminals + rhs.numOfNonterminals);
		args.add(lhs);
		args.add(rhs);
	}

	protected OpOr(List<Node> args) {
	...
	@Override
	public OpOr clone(List<Node> args) {
