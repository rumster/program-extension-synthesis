...
/**
 * A transition relation where each state has at most one enabled action and
 * each action has at most one outcome for any given state.
 * 
 * @author romanm
 *
 * @param <StateType>
 ...
 */
public interface FullyDeterministicTR<StateType, ActionType> extends TR<StateType, ActionType> {
	/**
