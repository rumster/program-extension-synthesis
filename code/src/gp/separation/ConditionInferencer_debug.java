...
public class ConditionInferencer_debug extends ConditionInferencer<Store, Stmt, BoolExpr> {
	...
	private List<BoolExpr> merge_conds() {
		...
		BoolExpr cond1 = new OrExpr(new NotExpr(new EqExpr(first, NullExpr.v)),
		...
		BoolExpr cond2 = new AndExpr(cond1,
				new OrExpr(new EqExpr(second, NullExpr.v), new AndExpr(new NotExpr(new EqExpr(first, NullExpr.v)),
		...
		BoolExpr cond3 = new AndExpr(cond1,
				new NotExpr(new OrExpr(new EqExpr(second, NullExpr.v),
						new AndExpr(new NotExpr(new EqExpr(first, NullExpr.v)),
								new LtExpr(new DerefExpr(second, val), new DerefExpr(first, val))))));
